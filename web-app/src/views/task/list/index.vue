<template>
  <div>
    ...
    <el-table :data="showList" row-key="taskId" v-loading="loading">
      <el-table-column prop="title" label="任务名" width="180" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column prop="endDate" label="结束日期" width="180">
        <span slot-scope="scope" v-html="btyDate(scope.row.endDate)">{{
          scope.row.endDate
        }}</span>
      </el-table-column>
